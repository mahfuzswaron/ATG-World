...
const Banner = () => {
    return (
        <div className=''>
            ...
            <div className='relative w-96 lg:w-full mx-0'>
                <figure className=''>
                ...
                <button className="lg:hidden text-white btn btn-outline btn-transperant absolute top-5 right-5 z-1 normal-case">Join Group</button>
